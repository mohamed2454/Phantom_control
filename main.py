    ...
    async def open(self, i, b):
        try:
            ...
            if reasons:
                ...
                # إذا لم تكن هناك خيارات، نرسل أزرار الإدارة مباشرة
...
def guild_details(guild_id):
    try:
        ...
        # جلب الإعدادات الحالية من جدول config
...
# راوت حفظ أسباب التذاكر مجمعة بشكل نهائي
...
def save_ticket_reasons():
    try:
        ...
        # مسح الأسباب السابقة لتعديل القائمة وحفظها دفعة واحدة
        ...
        log_action_db("TICKET_REASONS_SAVE", "unknown", f"تم تحديث خيارات التذاكر للسيرفر {gid}")
